            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    mediapipeKeypoints = mediapipeResults
                        ...
                        keypoint.name]; }); })
                        .flat();
                    test_util_1.expectArraysClose(tfjsKeypoints.map(function (keypoint) { return [keypoint[0], keypoint[1]]; }), mediapipeKeypoints.map(function (keypoint) { return [keypoint[0], keypoint[1]]; }), EPSILON_IMAGE);
                    test_util_1.expectArraysEqual(tfjsKeypoints.map(function (keypoint) { return keypoint[2]; }), mediapipeKeypoints.map(function (keypoint) { return keypoint[2]; }));
